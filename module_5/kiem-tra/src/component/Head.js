    ...
    return(
      <>
          <div className="container-fluid px-0"
               style={{background: '-webkit-linear-gradient(left, #25c481, #25b7c4),linear-gradient(to right, #25c481, #25b7c4)'}}>
                      ...
                      <nav className="navbar navbar-expand-lg navbar-dark p-3 p-lg-0">
                          ...
                          <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                              <div className="navbar-nav mr-auto py-0">
                                  ...
                                  <a className="nav-item nav-link">Customer</a>
                                  <a className="nav-item nav-link">Services</a>
                                  <a className="nav-item nav-link">Contract</a>
                                   <a  class="nav-item nav-link">Contact</a>
                              </div>
                              <a href className="btn btn-primary rounded-0 py-4 px-md-5 d-none d-lg-block">Premium
                                  Version<i className="fa fa-arrow-right ms-3"/></a>
                          </div>
                      </nav>
                  </div>
              </div>
